...
iOS相比Android，没法用相同的价格买到更大的内存（杀后台情况相对较少）、120Hz的屏幕、快充、大电池、通话录音、更好的信号水平，但照相质量更高、统一推送更省心、软件质量更高、存储沙箱&权限控制更好、屏幕素质更好。

iOS更省心，Android更爽。

吐槽，苹果的硬件设计为了突出产品迭代而固执的选择了直角边框，导致开发者根本没得选择。Android的可选性多一些。
