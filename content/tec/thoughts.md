...
复盘很重要，它可以帮助人对已完成事项进行回顾，反省自己做得好的和不好的方面并沉淀下来，以应对未来的事情。复盘的目标不仅仅是大事、项目，也可以是生活中的细节之处，及时将生活中自己认为不满意的细节记录下来并反思为何如此、如何改进，会一点一滴的让生活趋于自己追求的样子。
...
计算工期要区分不同的功能类型，对于不同的功能有不同的实现时间要求，将其相加后再留适度的 buffer 即可（预计时间*2）。越大的项目，排期越不准，应当向产品明确出来这种风险。

所谓buffer，一般用于处理开发中才遇到的问题、阻塞项耽搁的时间、其他插入事项等。
